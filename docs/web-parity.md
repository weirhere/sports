...
| 2026-09-26 | Live polls ask only for the days with games in play; the whole window refreshes every 30s | **pending**: `use-league-scoreboards.ts` still re-asks for the whole five-day window on every 1s live tick. |
